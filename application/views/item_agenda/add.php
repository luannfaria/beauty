    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Item Agenda Add</h3>
            </div>
            <?php echo form_open('item_agenda/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idagenda" class="form-control">
								...
								{
									$selected = ($agenda['idagenda'] == $this->input->post('idagenda')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="idatendente" value="<?php echo $this->input->post('idatendente'); ?>" class="form-control" id="idatendente" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="valorservico" class="control-label">Valorservico</label>
						<div class="form-group">
							<input type="text" name="valorservico" value="<?php echo $this->input->post('valorservico'); ?>" class="form-control" id="valorservico" />
						</div>
					</div>
					<div class="col-md-6">
