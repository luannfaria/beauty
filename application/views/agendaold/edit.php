<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('agenda/edit/'.$agenda['idagenda']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idatendente" class="form-control">
								...
								{
									$selected = ($atendente['idatendente'] == $agenda['idatendente']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idcliente" class="form-control">
								...
								{
									$selected = ($cliente['idcliente'] == $agenda['idcliente']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dataagenda" value="<?php echo ($this->input->post('dataagenda') ? $this->input->post('dataagenda') : $agenda['dataagenda']); ?>" class="has-datepicker form-control" id="dataagenda" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="horaagenda" value="<?php echo ($this->input->post('horaagenda') ? $this->input->post('horaagenda') : $agenda['horaagenda']); ?>" class="form-control" id="horaagenda" />
