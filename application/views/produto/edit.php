    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Produto Edit</h3>
            </div>
			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idcategoria" class="form-control">
								...
								{
									$selected = ($categoria_prod_serv['idcategoria_prod_serv'] == $produto['idcategoria']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="marca" value="<?php echo ($this->input->post('marca') ? $this->input->post('marca') : $produto['marca']); ?>" class="form-control" id="marca" />
						</div>
					</div>
				</div>
			</div>
